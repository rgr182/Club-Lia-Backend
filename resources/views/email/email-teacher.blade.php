                                                                ...
                                                                <td style="background-color:#093E80; padding:50px 50px 30px 50px; line-height:22px; text-align:inherit;"
                                                                    ...
                                                                    <div>
                                                                        <div
                                                                            ...
                                                                            <h2 style="color:#ffffff; font-family: inherit; text-align: justify">
                                                                            Se registro un nuevo maestro en nuestra comunidad, favor de validar su información en tu cuenta de administrador CLUB LIA.
                                                                            </h2>

                                                                           <p style="color:#ffffff; font-family: inherit; text-align: justify"> Nombre: {{$data['name']}}&nbsp;</p>
                                                                           <p style="color:#ffffff; font-family: inherit; text-align: justify"> Apellidos: {{$data['last_name']}}&nbsp;</p>
                                                                           ...
                                                                           <p style="color:#ffffff; font-family: inherit; text-align: justify"> Escuela o empresa: {{$data['school_name']}}&nbsp;</p>
                                                                           <p style="color:#ffffff; font-family: inherit; text-align: justify"> Nivel educativo: {{$data['level_school']}}&nbsp;</p>
                                                                           <p style="color:#ffffff; font-family: inherit; text-align: justify"> Tipo de membresía interesado: {{$data['membership']}}&nbsp;</p>
                                                                        </div>
                                                                        <div></div>
                                                                    </div>
                                                                </td>
