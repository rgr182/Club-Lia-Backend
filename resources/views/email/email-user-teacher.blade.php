                                                                ...
                                                                <td style="background-color:#093E80; padding:50px 50px 30px 50px; line-height:22px; text-align:inherit;"
                                                                    ...
                                                                    <div>
                                                                        <div
                                                                           ...
                                                                           <p style="color:#ffffff; font-family: inherit; text-align: justify"> Contraseña: {{$data['userPassword']}}&nbsp;</p>
                                                                           <p style="color:#ffffff; font-family: inherit; text-align: justify"> Acceder: <a href='https://comunidad.clublia.com/apps/landing'>Club LIA</a>&nbsp;</p>
                                                                        </div>
                                                                        <div></div>
                                                                    </div>
                                                                </td>
