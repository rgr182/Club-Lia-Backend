                                                                ...
                                                                <td style="background-color:#093E80; padding:50px 50px 30px 50px; line-height:22px; text-align:inherit;"
                                                                    ...
                                                                    <div>
                                                                        <div
                                                                            ...
                                                                            <h2 style="color:#ffffff; font-family: inherit; text-align: justify">{{$data['subject']}}</h2>
                                                                            <p style="color:#ffffff; font-family: inherit; text-align: justify">Nombre: {{$data['schoolName']}}</p>&nbsp;
                                                                            <p style="color:#ffffff; font-family: inherit; text-align: justify">Email: {{$data['schoolMail']}}</p>&nbsp;
                                                                            <p style="color:#ffffff; font-family: inherit; text-align: justify">Tel: {{$data['schoolPhone']}}</p>&nbsp;
                                                                            <p style="color:#ffffff; font-family: inherit; text-align: justify">País: {{$data['schoolCountry']}}</p>&nbsp;
                                                                            <p style="color:#ffffff; font-family: inherit; text-align: justify">Estado: {{$data['schoolCity']}}</p>&nbsp;
                                                                            <p style="color:#ffffff; font-family: inherit; text-align: justify">Membresía: {{$data['membership']}}</p>&nbsp;
                                                                            <p style="color:#ffffff; font-family: inherit; text-align: justify">{{$data['message']}}</p>&nbsp;
                                                                        </div>
                                                                    </div>
                                                                </td>
                                                            </tr>
